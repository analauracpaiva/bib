...
async function save() {
  ...
  currentBook.cover_attachment_key = image.attachment_key
  ...
  <modal :visible="showForm" @close="showForm = false">
    ...
    <template #body>
      <form class="form">
        ...
        <div class="form-item">
          <input type="text" placeholder="Título" id="title" v-model="currentBook.title" />
        ...
        <div class="form-item">
          <select v-model="currentBook.rating">
